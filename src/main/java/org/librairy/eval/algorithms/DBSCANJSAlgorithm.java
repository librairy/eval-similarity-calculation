 ...
 */
public class DBSCANJSAlgorithm implements Algorithm {

    private final Integer minPoints;
    private int numPoints;

    public DBSCANJSAlgorithm(Integer minPoints){
    ...
    public List<DistributionExpression> getShapesFrom(List<DirichletDistribution> distributions) {
        ...
        double epsilon = 0.1;
        DistanceMeasure jensenShannonDivergence = (DistanceMeasure) (doubles, doubles1) -> JensenShannonDivergence.apply(doubles,doubles1);
        DBSCANClusterer dbscanClusterer = new DBSCANClusterer(epsilon, minPoints, jensenShannonDivergence);
    ...
    public String toString() {
        return "DBSCAN-JS-"+minPoints+" Algorithm";
    }
}
