...
public class CRDCTest {

    private static final Logger LOG = LoggerFactory.getLogger(CRDCTest.class);
    ...
    public void simpleLabel(){
        ...
        for (int i=0;i<=10;i++){
            ...
            LOG.info("l"+threshold+": " + new CRDCAlgorithm(threshold).getCluster(point));
        }
